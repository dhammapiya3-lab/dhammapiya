...
export const LESSON_MANGALA: StepType[] = [
  ...
  // ===== 보강: 단어 분해 =====
  { type: 'intro', icon: '🔬', title: '— 단어 추가 보강 —', subtitle: '복합어 구성요소·접속사',
    description: '게송 곳곳의 기본 단어 분해.' },

  { type: 'teach', icon: '🎯', word: 'karaṇīya', pronKo: '까라니~야', meaning: '해야 할 (미래분사)',
    grammar: '미래분사', baseForm: 'karaṇīya (√kar)',
    formNote: '"해야 할 일" — 게송 1 첫 단어',
    verseLine: V1, verseLineKo: V1K, audio: true },
  { type: 'teach', icon: '🎯', word: 'attha', pronKo: '앗타', meaning: '목적, 이익 (원형)',
    grammar: '남성명사', baseForm: 'attha',
    verseLine: V1, verseLineKo: V1K, audio: true },
  { type: 'teach', icon: '🧠', word: 'kusala', pronKo: '꾸살라', meaning: '능숙한, 선한 (원형)',
    grammar: '형용사', baseForm: 'kusala',
    formNote: '11과 MN10 V_MAG6C의 kusalānaṃ과 같은 단어',
    verseLine: V1, verseLineKo: V1K, audio: true },
  { type: 'teach', icon: '🕊️', word: 'santa', pronKo: '산따', meaning: '고요한 (원형)',
    grammar: '형용사/과거분사', baseForm: 'santa (√sam 고요해지다)',
    formNote: '11과 MN10 V_NIV1의 santaṃ과 어근 공유 (있는의 의미)',
    verseLine: V1, verseLineKo: V1K, audio: true },
  { type: 'teach', icon: '👣', word: 'pada', pronKo: '빠다', meaning: '발, 경지 (원형)',
    grammar: '중성명사', baseForm: 'pada',
    formNote: 'padaṃ santaṃ = 고요한 경지 = 열반',
    verseLine: V1, verseLineKo: V1K, audio: true },
  { type: 'teach', icon: '💎', word: 'pūjaneyya', pronKo: '뿌~자네이야', meaning: '공양받을 만한 (미래분사)',
    grammar: '미래분사', baseForm: 'pūjeti의 미래분사',
    formNote: '11과 4과 tisarana-guna 4쌍8배의 dakkhiṇeyya와 비슷 구조',
    verseLine: V1, verseLineKo: V1K, audio: true },
  { type: 'teach', icon: '🙏', word: 'pūjā', pronKo: '뿌~자~', meaning: '공양, 경배 (원형)',
    grammar: '여성명사', baseForm: 'pūjā',
    verseLine: V1, verseLineKo: V1K, audio: true },

  { type: 'teach', icon: '🏠', word: 'patirūpa', pronKo: '빠띠루~빠', meaning: '적합한 (원형)',
    grammar: '형용사', baseForm: 'pati + rūpa',
    verseLine: V2, verseLineKo: V2K, audio: true },
  { type: 'teach', icon: '🌍', word: 'desa', pronKo: '데사', meaning: '장소, 지방 (원형)',
    grammar: '남성명사', baseForm: 'desa',
    verseLine: V2, verseLineKo: V2K, audio: true },
  { type: 'teach', icon: '🏠', word: 'vāsa', pronKo: '와~사', meaning: '거주 (원형)',
    grammar: '남성명사', baseForm: 'vāsa (√vas 살다)',
    formNote: 'patirūpadesavāso = 복합어 주격',
    verseLine: V2, verseLineKo: V2K, audio: true },
  { type: 'teach', icon: '🌱', word: 'puñña', pronKo: '뿐냐', meaning: '공덕 (원형)',
    grammar: '중성명사', baseForm: 'puñña',
    formNote: '4과 tisarana-guna puññakkhetta(복전)의 puñña와 동일',
    buddhism: '복덕(福德). 선업의 결과.',
    verseLine: V2, verseLineKo: V2K, audio: true },
  { type: 'teach', icon: '👤', word: 'atta', pronKo: '앗따', meaning: '자기 (원형)',
    grammar: '대명사/명사', baseForm: 'atta',
    formNote: '9과 sn22-59의 attā와 같은 단어\nattasammāpaṇidhi = 자기 바른 향함',
    verseLine: V2, verseLineKo: V2K, audio: true },
  { type: 'teach', icon: '🎯', word: 'paṇidhi', pronKo: '빠니디', meaning: '향함, 결심 (원형)',
    grammar: '남성명사', baseForm: 'paṇidhi (pa + ni + √dhā)',
    formNote: '11과 MN10 V_ANA1의 paṇidhāya(절대분사)와 같은 어근',
    verseLine: V2, verseLineKo: V2K, audio: true },

  { type: 'teach', icon: '📚', word: 'bahu', pronKo: '바후', meaning: '많은 (원형)',
    grammar: '형용사', baseForm: 'bahu',
    verseLine: V3, verseLineKo: V3K, audio: true },
  { type: 'teach', icon: '💡', word: 'sacca', pronKo: '삿짜', meaning: '진리/들음 (원형)',
    grammar: '중성명사', baseForm: 'sacca',
    formNote: '여기 bāhusacca의 sacca = "들음, 학식"\n10과 ratana의 sacca(진리)와 같은 단어 (다중 의미)',
    verseLine: V3, verseLineKo: V3K, audio: true },
  { type: 'teach', icon: '🔨', word: 'sippa', pronKo: '십빠', meaning: '기예 (원형)',
    grammar: '중성명사', baseForm: 'sippa',
    verseLine: V3, verseLineKo: V3K, audio: true },
  { type: 'teach', icon: '📜', word: 'vinaya', pronKo: '위나야', meaning: '율, 다스림 (원형)',
    grammar: '남성명사', baseForm: 'vinaya (vi + √nī)',
    formNote: '삼장의 vinaya-piṭaka(율장)',
    buddhism: '율(律). 비구·비구니 계율.',
    verseLine: V3, verseLineKo: V3K, audio: true },
  { type: 'teach', icon: '🎓', word: 'sikkhita', pronKo: '식키따', meaning: '익힌 (과거분사)',
    grammar: '과거분사', baseForm: 'sikkhati의 과거분사',
    formNote: 'susikkhita = "잘 익힌"\n11과 MN10 V_ANA1의 sikkhati와 같은 어근',
    verseLine: V3, verseLineKo: V3K, audio: true },
  { type: 'teach', icon: '🗣️', word: 'vācā', pronKo: '와~짜~', meaning: '말 (원형)',
    grammar: '여성명사', baseForm: 'vācā',
    formNote: '11과 MN10 V_MAG3의 sammāvācā와 같은 단어',
    verseLine: V3, verseLineKo: V3K, audio: true },

  { type: 'teach', icon: '👶', word: 'putta', pronKo: '뿟따', meaning: '아들·자식 (원형)',
    grammar: '남성명사', baseForm: 'putta',
    verseLine: V4, verseLineKo: V4K, audio: true },
  { type: 'teach', icon: '👰', word: 'dāra', pronKo: '다~라', meaning: '아내 (원형)',
    grammar: '남성명사', baseForm: 'dāra',
    formNote: 'puttadārassa = 자식+아내의 (속격) 복합어',
    verseLine: V4, verseLineKo: V4K, audio: true },
  { type: 'teach', icon: '🤝', word: 'saṅgaha', pronKo: '상가하', meaning: '돌봄, 섭수 (원형)',
    grammar: '남성명사', baseForm: 'saṅgaha (saṃ + √gah)',
    verseLine: V4, verseLineKo: V4K, audio: true },
  { type: 'teach', icon: '🛠️', word: 'kammanta', pronKo: '깜만따', meaning: '일, 행위 (원형)',
    grammar: '남성명사', baseForm: 'kammanta',
    formNote: '11과 MN10 V_MAG4의 sammākammanta와 같은 단어',
    verseLine: V4, verseLineKo: V4K, audio: true },

  { type: 'teach', icon: '📜', word: 'dhammacariyā', pronKo: '담마짜리야~', meaning: '법행 (원형)',
    grammar: '복합어', baseForm: 'dhamma + cariyā(행)',
    verseLine: V5, verseLineKo: V5K, audio: true },
  { type: 'teach', icon: '👨‍👩‍👧', word: 'ñātaka', pronKo: '냐~따까', meaning: '친족 (원형)',
    grammar: '남성명사', baseForm: 'ñātaka',
    formNote: '4과 tisarana-guna의 ñātisālohitā와 어원 공유',
    verseLine: V5, verseLineKo: V5K, audio: true },
  { type: 'teach', icon: '✅', word: 'anavajja', pronKo: '아나왓자', meaning: '비난받지 않는 (원형)',
    grammar: '형용사', baseForm: 'an + avajja',
    verseLine: V5, verseLineKo: V5K, audio: true },

  { type: 'teach', icon: '🚫', word: 'ārati / virati', pronKo: '아~라띠 / 위라띠', meaning: '멀리함 / 삼감',
    grammar: '여성명사', baseForm: 'ārati + virati',
    formNote: '3과 pancasila의 veramaṇī와 같은 어근',
    verseLine: V6, verseLineKo: V6K, audio: true },
  { type: 'teach', icon: '😈', word: 'pāpa', pronKo: '빠~빠', meaning: '악 (원형)',
    grammar: '중성명사', baseForm: 'pāpa',
    formNote: '11과 MN10 V_MAG6A의 pāpakānaṃ과 같은 단어',
    verseLine: V6, verseLineKo: V6K, audio: true },
  { type: 'teach', icon: '🍺', word: 'majjapāna', pronKo: '맛자빠~나', meaning: '음주 (원형)',
    grammar: '복합어', baseForm: 'majja + pāna',
    formNote: '3과 pancasila의 majja와 같은 단어',
    verseLine: V6, verseLineKo: V6K, audio: true },
  { type: 'teach', icon: '🛡️', word: 'saṃyama', pronKo: '상야마', meaning: '절제 (원형)',
    grammar: '남성명사', baseForm: 'saṃyama (saṃ + √yam)',
    verseLine: V6, verseLineKo: V6K, audio: true },
  { type: 'teach', icon: '⚡', word: 'appamāda', pronKo: '압빠마~다', meaning: '불방일 (원형)',
    grammar: '남성명사', baseForm: 'a + pamāda',
    formNote: '3과 pancasila의 pamāda(방일)의 부정\n부처님 마지막 유훈',
    buddhism: '불방일(不放逸).',
    verseLine: V6, verseLineKo: V6K, audio: true },

  { type: 'teach', icon: '🙇', word: 'gārava', pronKo: '가~라와', meaning: '공경 (원형)',
    grammar: '남성명사', baseForm: 'gārava',
    verseLine: V7, verseLineKo: V7K, audio: true },
  { type: 'teach', icon: '😌', word: 'nivāta', pronKo: '니와~따', meaning: '겸손 (원형)',
    grammar: '남성명사', baseForm: 'nivāta',
    formNote: '"바람 없음" → 겸손',
    verseLine: V7, verseLineKo: V7K, audio: true },
  { type: 'teach', icon: '🙏', word: 'kataññū', pronKo: '까딴뉴~', meaning: '은혜 아는 자 (원형)',
    grammar: '형용사', baseForm: 'kata(된) + ñū(아는)',
    verseLine: V7, verseLineKo: V7K, audio: true },
  { type: 'teach', icon: '⏰', word: 'kāla', pronKo: '깔~라', meaning: '때 (원형)',
    grammar: '남성명사', baseForm: 'kāla',
    formNote: 'kālena = 도구격 "때에 맞춰"',
    verseLine: V7, verseLineKo: V7K, audio: true },
  { type: 'teach', icon: '👂', word: 'dhammassavana', pronKo: '담맛사와나', meaning: '법문 (원형)',
    grammar: '복합어', baseForm: 'dhamma + savana (들음)',
    verseLine: V7, verseLineKo: V7K, audio: true },

  { type: 'teach', icon: '😤', word: 'khanti', pronKo: '칸띠', meaning: '인내 (원형)',
    grammar: '여성명사', baseForm: 'khanti (√kham)',
    buddhism: '인욕(忍辱). 6바라밀의 셋째.',
    verseLine: V8, verseLineKo: V8K, audio: true },
  { type: 'teach', icon: '🧘', word: 'samaṇa', pronKo: '사마나', meaning: '사문, 출가 수행자 (원형)',
    grammar: '남성명사', baseForm: 'samaṇa',
    formNote: '5과 sn45-8의 samaṇa(사문)과 동일',
    verseLine: V8, verseLineKo: V8K, audio: true },
  { type: 'teach', icon: '👁️', word: 'dassana', pronKo: '닷사나', meaning: '봄, 친견 (원형)',
    grammar: '중성명사', baseForm: 'dassana (√das 보다)',
    verseLine: V8, verseLineKo: V8K, audio: true },
  { type: 'teach', icon: '💬', word: 'sākacchā', pronKo: '사~깟차~', meaning: '담론 (원형)',
    grammar: '여성명사', baseForm: 'sākacchā',
    verseLine: V8, verseLineKo: V8K, audio: true },

  { type: 'teach', icon: '🔥', word: 'tapa', pronKo: '따빠', meaning: '정진, 고행 (원형)',
    grammar: '남성명사', baseForm: 'tapa (√tap)',
    formNote: '11과 MN10의 ātāpī와 같은 어근',
    verseLine: V9, verseLineKo: V9K, audio: true },
  { type: 'teach', icon: '🕊️', word: 'brahmacariya', pronKo: '브라흐마짜리야', meaning: '범행 (원형)',
    grammar: '중성명사', baseForm: 'brahma + cariya',
    formNote: '5과 sn45-8의 abrahmacariyā(범행 아님)의 긍정형',
    verseLine: V9, verseLineKo: V9K, audio: true },
  { type: 'teach', icon: '👁️', word: 'ariyasacca', pronKo: '아리야삿짜', meaning: '성스러운 진리 (원형)',
    grammar: '복합어', baseForm: 'ariya + sacca',
    formNote: '11과 MN10 V_SAC0의 ariyasacca와 동일',
    verseLine: V9, verseLineKo: V9K, audio: true },

  { type: 'teach', icon: '✋', word: 'phuṭṭha', pronKo: '풋타', meaning: '닿은 (과거분사)',
    grammar: '과거분사', baseForm: 'phuṭṭha (√phus)',
    formNote: 'phuṭṭhassa = 속격 "닿은 자의"',
    verseLine: V10, verseLineKo: V10K, audio: true },
  { type: 'teach', icon: '🌪️', word: 'lokadhamma', pronKo: '로까담마', meaning: '세속법 (원형)',
    grammar: '복합어', baseForm: 'loka + dhamma',
    formNote: '8풍: 득·실·명·예·칭·기·고·락',
    buddhism: '세속8법.',
    verseLine: V10, verseLineKo: V10K, audio: true },
  { type: 'teach', icon: '🗿', word: 'kampati', pronKo: '깜빠띠', meaning: '흔들리다',
    grammar: '동사 3인칭 단수', baseForm: 'kampati (√kamp)',
    verseLine: V10, verseLineKo: V10K, audio: true },
  { type: 'teach', icon: '😌', word: 'asoka', pronKo: '아소까', meaning: '슬픔 없는 (원형)',
    grammar: '형용사', baseForm: 'a + soka',
    verseLine: V10, verseLineKo: V10K, audio: true },
  { type: 'teach', icon: '✨', word: 'viraja', pronKo: '위라자', meaning: '티끌 없는 (원형)',
    grammar: '형용사', baseForm: 'vi + raja(티끌)',
    verseLine: V10, verseLineKo: V10K, audio: true },
  { type: 'teach', icon: '🕊️', word: 'khema', pronKo: '케마', meaning: '안온한 (원형)',
    grammar: '형용사', baseForm: 'khema',
    verseLine: V10, verseLineKo: V10K, audio: true },
