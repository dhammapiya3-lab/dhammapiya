...
export const LESSON_RATANA: StepType[] = [
  ...
  // ===== 보강: 빈출 단어·접속사·기본형 =====
  { type: 'intro', icon: '🔬', title: '— 단어 추가 보강 —', subtitle: '게송 곳곳의 빈출 단어',
    description: '여러 게송에 나오는 기본 단어와 화합어 구성요소.' },

  { type: 'teach', icon: '👥', word: 'Yānīdha', pronKo: '야~니~다', meaning: '여기 있는 (관계대명사+처격부사)',
    grammar: '관계대명사 복수+부사', baseForm: 'yāni(어떤 것들) + idha(여기)',
    formNote: 'yāni + idha → yānīdha (산디)', verseLine: V0A, verseLineKo: V0AK, audio: true },
  { type: 'teach', icon: '👻', word: 'bhūta', pronKo: '부~따', meaning: '존재, 신령 (원형)',
    grammar: '중성명사, 원형', baseForm: 'bhūta',
    formNote: '√bhū(있다)의 과거분사 → "있는 것 = 존재"',
    verseLine: V0A, verseLineKo: V0AK, audio: true },
  { type: 'teach', icon: '☁️', word: 'antalikkha', pronKo: '안딸릭카', meaning: '허공, 중간공간 (원형)',
    grammar: '중성명사, 원형', baseForm: 'antalikkha',
    formNote: 'antalikkhe = 처격', verseLine: V0A, verseLineKo: V0AK, audio: true },
  { type: 'teach', icon: '✌️', word: 'vā / va', pronKo: '와~ / 와', meaning: '또는 (선택)',
    grammar: '접속사', baseForm: 'vā',
    formNote: 'va는 vā의 단축형 (운율 맞춤)\n11과 MN10 V_IRI의 vā와 동일',
    verseLine: V0A, verseLineKo: V0AK, audio: true },
  { type: 'teach', icon: '🌟', word: 'sabbeva', pronKo: '삽베와', meaning: '모두 다 (강조)',
    grammar: '대명사 복수+강조', baseForm: 'sabbe + eva',
    formNote: 'sabbe(모든 자들) + eva(강조) = "모두 다"',
    verseLine: V0A, verseLineKo: V0AK, audio: true },
  { type: 'teach', icon: '😄', word: 'sumana', pronKo: '수마나', meaning: '기쁜 마음의 (원형)',
    grammar: '형용사, 원형', baseForm: 'su + mana',
    formNote: 'su(잘) + mana(마음) = "마음이 좋은"',
    verseLine: V0A, verseLineKo: V0AK, audio: true },
  { type: 'teach', icon: '🔗', word: 'athopi', pronKo: '아토삐', meaning: '그리고 또한',
    grammar: '부사 + api', baseForm: 'atho + pi',
    formNote: 'atho(또한) + pi(도) = "그리고 또한"',
    verseLine: V0A, verseLineKo: V0AK, audio: true },
  { type: 'teach', icon: '🎯', word: 'sakkacca', pronKo: '삭깟짜', meaning: '주의 깊게',
    grammar: '부사', baseForm: 'sakkacca',
    verseLine: V0A, verseLineKo: V0AK, audio: true },
  { type: 'teach', icon: '💬', word: 'bhāsitaṃ', pronKo: '바~시땅', meaning: '말씀을 (대격)',
    grammar: '과거분사, 대격', baseForm: 'bhāsita (√bhās)',
    formNote: '11과 MN10 V_END4의 bhāsitaṃ과 동일',
    verseLine: V0A, verseLineKo: V0AK, audio: true },

  { type: 'teach', icon: '👂', word: 'nisāmetha', pronKo: '니사~메타', meaning: '귀를 기울이라 (2복명령)',
    grammar: '동사 2인칭 복수 명령', baseForm: 'nisāmeti',
    verseLine: V0B, verseLineKo: V0BK, audio: true },
  { type: 'teach', icon: '👥', word: 'mānusiyā pajāya', pronKo: '마~누시야~ 빠자~야', meaning: '인간의 무리에게 (여격)',
    grammar: '형용사+명사 여격', baseForm: 'mānusiya + pajā',
    verseLine: V0B, verseLineKo: V0BK, audio: true },
  { type: 'teach', icon: '🌅', word: 'divā ca ratto ca', pronKo: '디와~ 짜 랏또 짜', meaning: '낮과 밤으로',
    grammar: '부사 + ca + 부사 + ca', baseForm: 'divā(낮에) + ratti(밤에)',
    verseLine: V0B, verseLineKo: V0BK, audio: true },
  { type: 'teach', icon: '🚚', word: 'haranti', pronKo: '하란띠', meaning: '가져온다 (3복현재)',
    grammar: '동사 3인칭 복수 현재', baseForm: 'harati (√har)',
    verseLine: V0B, verseLineKo: V0BK, audio: true },

  { type: 'teach', icon: '❓', word: 'yaṃ kiñci', pronKo: '양 낀찌', meaning: '어떤 ~이든',
    grammar: '관계대명사+부정대명사', baseForm: 'yaṃ + kiñci',
    formNote: '9과 sn22-59 V7에서도 사용',
    verseLine: V1, verseLineKo: V1K, audio: true },
  { type: 'teach', icon: '📍', word: 'idha', pronKo: '이다', meaning: '여기 (이 세상)',
    grammar: '부사', baseForm: 'idha',
    formNote: '11과 MN10 V3의 idha와 동일',
    verseLine: V1, verseLineKo: V1K, audio: true },
  { type: 'teach', icon: '🌌', word: 'huraṃ', pronKo: '후랑', meaning: '저 세상',
    grammar: '부사', baseForm: 'huraṃ',
    verseLine: V1, verseLineKo: V1K, audio: true },
  { type: 'teach', icon: '☁️', word: 'sagga', pronKo: '삭가', meaning: '천상 (원형)',
    grammar: '남성명사, 원형', baseForm: 'sagga',
    formNote: 'saggesu = 처격 복수',
    buddhism: '6욕천 + 색계·무색계 = 31천.',
    verseLine: V1, verseLineKo: V1K, audio: true },
  { type: 'teach', icon: '⚖️', word: 'samaṃ', pronKo: '사망', meaning: '같은',
    grammar: '형용사, 주격 중성', baseForm: 'sama',
    verseLine: V1, verseLineKo: V1K, audio: true },
  { type: 'teach', icon: '✅', word: 'atthi', pronKo: '앗티', meaning: '있다',
    grammar: '동사 3인칭 단수', baseForm: 'atthi (√as)',
    formNote: '11과 MN10 REF_KAYA의 atthi와 동일',
    verseLine: V1, verseLineKo: V1K, audio: true },
  { type: 'teach', icon: '👼', word: 'tathāgata', pronKo: '따타~가따', meaning: '여래 (원형)',
    grammar: '남성명사, 원형', baseForm: 'tathā + gata',
    formNote: 'tathā(그렇게) + gata(간) = "그렇게 간 분"\ntathāgatena = 도구격',
    buddhism: '여래(如來). 부처님의 자칭.',
    verseLine: V1, verseLineKo: V1K, audio: true },
  { type: 'teach', icon: '👇', word: 'idampi', pronKo: '이담삐', meaning: '이것 또한',
    grammar: '대명사+api', baseForm: 'idaṃ + pi',
    formNote: '후렴의 시작 — "이것 또한 [삼보] 안의 보배"',
    verseLine: V1, verseLineKo: V1K, audio: true },
  { type: 'teach', icon: '☸️', word: 'buddhe', pronKo: '붓데', meaning: '붓다 안에 (처격)',
    grammar: '남성명사, 처격', baseForm: 'buddha',
    verseLine: V1, verseLineKo: V1K, audio: true },
  ...
  { type: 'teach', icon: '🙏', word: 'sakyamuni', pronKo: '사꺄무니', meaning: '석가모니 (원형)',
    grammar: '남성명사, 원형', baseForm: 'sakya(석가족) + muni(성자)',
    buddhism: '석가족의 성자 = 부처님.',
    verseLine: V2, verseLineKo: V2K, audio: true },
  { type: 'teach', icon: '🏔️', word: 'buddhaseṭṭho', pronKo: '붓다셋토', meaning: '붓다 중 최고',
    grammar: '복합어, 주격', baseForm: 'buddha + seṭṭha (최고)',
    verseLine: V3, verseLineKo: V3K, audio: true },
  { type: 'teach', icon: '🎯', word: 'samādhi', pronKo: '사마~디', meaning: '삼매 (원형)',
    grammar: '남성명사, 원형', baseForm: 'samādhi',
    formNote: 'samādhinā = 도구격. samādhimānantarikaṃ = 복합어 대격',
    buddhism: '11과 MN10 V_BOJ6 samādhisambojjhaṅga와 동일.',
    verseLine: V3, verseLineKo: V3K, audio: true },

  { type: 'teach', icon: '👏', word: 'pasattha', pronKo: '빠삿타', meaning: '칭송받는 (원형)',
    grammar: '과거분사, 원형', baseForm: 'pasattha',
    formNote: 'pasatthā = 주격 복수', verseLine: V4, verseLineKo: V4K, audio: true },
  { type: 'teach', icon: '🚢', word: 'sugata', pronKo: '수가따', meaning: '선서 (잘 가신 분)',
    grammar: '복합어, 원형', baseForm: 'su + gata',
    formNote: 'sugatassa = 속격\n6과 tisarana-guna의 Sugato와 동일',
    verseLine: V4, verseLineKo: V4K, audio: true },
  { type: 'teach', icon: '🎓', word: 'sāvaka', pronKo: '사~와까', meaning: '제자 (원형)',
    grammar: '남성명사, 원형', baseForm: 'sāvaka (√su 듣다)',
    formNote: '"들은 자" = 제자\nsāvakā = 주격 복수\n5과 sn45-8 ariyasāvako와 같은 단어',
    verseLine: V4, verseLineKo: V4K, audio: true },
  { type: 'teach', icon: '🎁', word: 'dinnāni', pronKo: '딘나~니', meaning: '주어진 것들 (과거분사 주격복수)',
    grammar: '과거분사, 주격 중성 복수', baseForm: 'dinna',
    verseLine: V4, verseLineKo: V4K, audio: true },
  { type: 'teach', icon: '🌾', word: 'mahapphala', pronKo: '마합팔라', meaning: '큰 결실 (원형)',
    grammar: '복합어', baseForm: 'mahā + phala',
    formNote: 'mahapphalāni = 주격 복수', verseLine: V4, verseLineKo: V4K, audio: true },

  { type: 'teach', icon: '💪', word: 'manasā daḷhena', pronKo: '마나사~ 달헤나', meaning: '굳건한 마음으로 (도구격)',
    grammar: '도구격', baseForm: 'mano + daḷha',
    verseLine: V5, verseLineKo: V5K, audio: true },
  { type: 'teach', icon: '🌿', word: 'gotamasāsanamhi', pronKo: '고따마사~사남히', meaning: '고따마의 가르침에서 (처격)',
    grammar: '복합어, 처격', baseForm: 'gotama + sāsana',
    verseLine: V5, verseLineKo: V5K, audio: true },
  { type: 'teach', icon: '🎁', word: 'mudhā', pronKo: '무다~', meaning: '값없이, 거저',
    grammar: '부사', baseForm: 'mudhā',
    verseLine: V5, verseLineKo: V5K, audio: true },

  { type: 'teach', icon: '🌳', word: 'sappurisa', pronKo: '삽뿌리사', meaning: '선인 (원형)',
    grammar: '복합어, 원형', baseForm: 'sat + purisa',
    formNote: 'sat(선) + purisa(사람) = 선한 사람',
    verseLine: V6, verseLineKo: V6K, audio: true },
  { type: 'teach', icon: '🗣️', word: 'vadāmi', pronKo: '와다~미', meaning: '나는 말한다',
    grammar: '동사 1인칭 단수', baseForm: 'vadati (√vad)',
    verseLine: V6, verseLineKo: V6K, audio: true },

  { type: 'teach', icon: '🧠', word: 'gambhīrapaññena', pronKo: '감비~라빤녜나', meaning: '심오한 지혜로 (도구격)',
    grammar: '복합어, 도구격', baseForm: 'gambhīra(심오한) + paññā',
    verseLine: V7, verseLineKo: V7K, audio: true },
  { type: 'teach', icon: '🎤', word: 'sudesita', pronKo: '수데시따', meaning: '잘 설해진 (원형)',
    grammar: '과거분사', baseForm: 'su + desita',
    verseLine: V7, verseLineKo: V7K, audio: true },
  { type: 'teach', icon: '⚠️', word: 'bhusaṃ pamattā', pronKo: '부상 빠맛따~', meaning: '크게 방일한',
    grammar: '부사+과거분사', baseForm: 'bhusa(강한) + pamatta',
    verseLine: V7, verseLineKo: V7K, audio: true },

  { type: 'teach', icon: '👁️', word: 'dassanasampadā', pronKo: '닷사나삼빠다~', meaning: '봄(견)의 성취',
    grammar: '복합어', baseForm: 'dassana(봄) + sampadā',
    buddhism: '예류과의 표지 = 사성제 직관.',
    verseLine: V8, verseLineKo: V8K, audio: true },
  { type: 'teach', icon: '3️⃣', word: 'tayassu dhammā jahitā', pronKo: '따얏수 담마~ 자히따~', meaning: '세 법이 버려진다',
    grammar: '수사+주격+과거분사', baseForm: 'tayo + dhamma + jahita',
    verseLine: V8, verseLineKo: V8K, audio: true },

  { type: 'teach', icon: '💀', word: 'kamma pāpakaṃ', pronKo: '깜마 빠~빠깡', meaning: '악업',
    grammar: '주격+형용사', baseForm: 'kamma + pāpaka',
    verseLine: V9, verseLineKo: V9K, audio: true },
  { type: 'teach', icon: '🫥', word: 'paṭicchadāya', pronKo: '빠띳차다~야', meaning: '감추기 위해 (여격)',
    grammar: '여격', baseForm: 'paṭicchada',
    verseLine: V9, verseLineKo: V9K, audio: true },

  { type: 'teach', icon: '🌳', word: 'vana', pronKo: '와나', meaning: '숲 (원형)',
    grammar: '중성명사', baseForm: 'vana',
    verseLine: V10, verseLineKo: V10K, audio: true },
  { type: 'teach', icon: '🌸', word: 'phussitagga', pronKo: '풋시딱가', meaning: '꽃핀 꼭대기',
    grammar: '복합어', baseForm: 'phussita + agga (꼭대기)',
    verseLine: V10, verseLineKo: V10K, audio: true },
  { type: 'teach', icon: '📢', word: 'adesayi', pronKo: '아데사이', meaning: '설하셨다 (3인칭 단수 아오리스트)',
    grammar: '동사 3인칭 단수 아오리스트', baseForm: 'deseti (√dis)',
    formNote: '5과 sn45-8의 desessāmi(미래)와 같은 어근',
    verseLine: V10, verseLineKo: V10K, audio: true },

  { type: 'teach', icon: '🌌', word: 'varaññū', pronKo: '와란뉴~', meaning: '최고를 아는',
    grammar: '복합어', baseForm: 'vara + ññū',
    verseLine: V11, verseLineKo: V11K, audio: true },
  { type: 'teach', icon: '🎁', word: 'varado', pronKo: '와라도', meaning: '최고를 주는',
    grammar: '복합어', baseForm: 'vara + da (주는 자)',
    verseLine: V11, verseLineKo: V11K, audio: true },
  { type: 'teach', icon: '🚚', word: 'varāharo', pronKo: '와라~하로', meaning: '최고를 가져오는',
    grammar: '복합어', baseForm: 'vara + āhara',
    verseLine: V11, verseLineKo: V11K, audio: true },

  { type: 'teach', icon: '🌱', word: 'khīṇabīja', pronKo: '키~나비~자', meaning: '종자 다한 (원형)',
    grammar: '복합어', baseForm: 'khīṇa(다한) + bīja(종자)',
    buddhism: '윤회의 종자 = 갈애·무명. 다하면 아라한.',
    verseLine: V12, verseLineKo: V12K, audio: true },
  { type: 'teach', icon: '🚫', word: 'avirūḷhichanda', pronKo: '아위루~흘리찬다', meaning: '자라남의 의욕이 없는',
    grammar: '복합어', baseForm: 'a + virūḷhi + chanda',
    verseLine: V12, verseLineKo: V12K, audio: true },
  { type: 'teach', icon: '💡', word: 'padīpa', pronKo: '빠디~빠', meaning: '등불 (원형)',
    grammar: '남성명사', baseForm: 'padīpa',
    formNote: 'padīpo = 주격 단수',
    verseLine: V12, verseLineKo: V12K, audio: true },
  { type: 'teach', icon: '🧙', word: 'dhīra', pronKo: '디~라', meaning: '지혜로운 자 (원형)',
    grammar: '형용사', baseForm: 'dhīra',
    formNote: 'dhīrā = 주격 복수',
    verseLine: V12, verseLineKo: V12K, audio: true },
  { type: 'teach', icon: '🔥', word: 'nibbāyati / nibbanti', pronKo: '닙바~야띠 / 닙반띠', meaning: '꺼진다 / 꺼진다(복수)',
    grammar: '동사 3인칭', baseForm: 'nibbāyati',
    formNote: 'nibbāna(열반)의 동사형 — "꺼지다"\n11과 MN10 V2의 nibbāna와 같은 어원',
    buddhism: '반열반(parinibbāna)의 동사 어근.',
    verseLine: V12, verseLineKo: V12K, audio: true },
