...
export const LESSON_SN22_59: StepType[] = [
  ...
  // ===== 보강: 단어 분해·접속사·기본형 =====
  { type: 'intro', icon: '🔬', title: '— 단어 추가 보강 —', subtitle: '본문의 빈출 단어·접속사·격변화',
    description: '논증 정형구에 등장하는 부수 단어들.' },

  { type: 'teach', icon: '➕', word: 'ca', pronKo: '짜', meaning: '그리고 (접속사)',
    grammar: '불변사 (접속)', baseForm: 'ca',
    formNote: '단어 뒤에 위치. "X ca Y ca" = "X와 Y"\n2과 trisarana의 -pi와 함께 가장 빈번',
    verseLine: V3, verseLineKo: V3K, audio: true },
  { type: 'teach', icon: '❗', word: 'hi', pronKo: '히', meaning: '실로, 진실로 (강조)',
    grammar: '불변사 (강조)', baseForm: 'hi',
    formNote: 'hidaṃ = hi + idaṃ',
    verseLine: V3, verseLineKo: V3K, audio: true },
  { type: 'teach', icon: '👉', word: 'hidaṃ', pronKo: '히당', meaning: '실로 이 (강조)',
    grammar: '강조+지시대명사', baseForm: 'hi + idaṃ',
    verseLine: V3, verseLineKo: V3K, audio: true },
  { type: 'teach', icon: '🚫', word: 'na', pronKo: '나', meaning: '~아니다 (부정)',
    grammar: '부정 불변사', baseForm: 'na',
    formNote: '동사/형용사 앞 부정\nnayidaṃ = na + idaṃ',
    verseLine: V3, verseLineKo: V3K, audio: true },
  { type: 'teach', icon: '🚫', word: 'nayidaṃ', pronKo: '나이당', meaning: '이것은 ~아니다',
    grammar: '부정+지시대명사', baseForm: 'na + idaṃ',
    verseLine: V3, verseLineKo: V3K, audio: true },
  { type: 'teach', icon: '⛔', word: 'mā', pronKo: '마~', meaning: '~하지 말기를 (금지)',
    grammar: '금지 불변사', baseForm: 'mā',
    formNote: 'mā + 아오리스트 = 금지 명령\nmā ahosi = "있지 말기를"',
    verseLine: V3, verseLineKo: V3K, audio: true },

  { type: 'teach', icon: '🤒', word: 'ābādha', pronKo: '아~바~다', meaning: '병고, 고통 (원형)',
    grammar: '남성명사, 원형', baseForm: 'ābādha',
    formNote: 'ābādhāya = 여격 "병고로"',
    verseLine: V3, verseLineKo: V3K, audio: true },
  { type: 'teach', icon: '🛤️', word: 'saṃvattati', pronKo: '상왓따띠', meaning: '이끈다',
    grammar: '동사 3인칭 단수', baseForm: 'saṃvattati (saṃ + √vatt)',
    formNote: '11과 MN10 sn56-11의 saṃvattati와 동일',
    verseLine: V3, verseLineKo: V3K, audio: true },
  { type: 'teach', icon: '✋', word: 'labbhati', pronKo: '랍바띠', meaning: '얻어진다, 가능하다',
    grammar: '동사 3인칭 단수 수동', baseForm: 'labhati 수동',
    formNote: 'labbhetha = 가능법 (수동 가정)',
    verseLine: V3, verseLineKo: V3K, audio: true },

  { type: 'teach', icon: '🤔', word: 'maññati', pronKo: '만냐띠', meaning: '생각하다, 여기다',
    grammar: '동사 3인칭 단수', baseForm: 'maññati',
    formNote: 'maññatha = 2인칭 복수 "그대들 생각하느냐?"',
    verseLine: V6, verseLineKo: V6K, audio: true },
  { type: 'teach', icon: '♾️', word: 'nicca', pronKo: '닛짜', meaning: '영원한 (원형)',
    grammar: '형용사, 원형', baseForm: 'nicca',
    formNote: '"영원" = niccaṃ\n a-nicca = anicca(무상) — 삼법인의 첫째',
    buddhism: '상(常). 무상의 반대.',
    verseLine: V6, verseLineKo: V6K, audio: true },
  { type: 'teach', icon: '🌊', word: 'anicca', pronKo: '아닛짜', meaning: '무상 (원형)',
    grammar: '형용사, 원형', baseForm: 'a + nicca',
    buddhism: '무상(無常). 삼법인의 첫째.',
    verseLine: V6, verseLineKo: V6K, audio: true },
  { type: 'teach', icon: '😄', word: 'sukha', pronKo: '수카', meaning: '즐거움 (원형)',
    grammar: '형용사/명사', baseForm: 'sukha',
    formNote: '11과 MN10 V_VED1의 sukhaṃ과 동일',
    verseLine: V6, verseLineKo: V6K, audio: true },
  { type: 'teach', icon: '🔄', word: 'vipariṇāma', pronKo: '위빠리나~마', meaning: '변화 (원형)',
    grammar: '남성명사, 원형', baseForm: 'vipariṇāma (vi + pari + √nam)',
    verseLine: V6, verseLineKo: V6K, audio: true },

  { type: 'teach', icon: '👀', word: 'samanupassati', pronKo: '사마누빳사띠', meaning: '바라본다, 본다',
    grammar: '동사 3인칭 단수', baseForm: 'sam + anu + √pas',
    formNote: 'samanupassituṃ = 부정사',
    verseLine: V6, verseLineKo: V6K, audio: true },
  { type: 'teach', icon: '⚖️', word: 'kalla', pronKo: '깔라', meaning: '적합한, 옳은',
    grammar: '형용사', baseForm: 'kalla',
    verseLine: V6, verseLineKo: V6K, audio: true },
  { type: 'teach', icon: '❌', word: 'no', pronKo: '노', meaning: '아니오 (부정)',
    grammar: '부정 불변사', baseForm: 'no',
    formNote: 'na의 강조형. "No hetaṃ" = "그렇지 않습니다"',
    verseLine: V6, verseLineKo: V6K, audio: true },

  { type: 'teach', icon: '👉', word: 'etaṃ mama', pronKo: '에땅 마마', meaning: '"이것은 내 것"',
    grammar: '지시대명사+속격', baseForm: 'eta + maṃ(나의)',
    buddhism: '아견(我見)의 첫째 — 갈애(taṇhā)의 표현.',
    verseLine: V6, verseLineKo: V6K, audio: true },
  { type: 'teach', icon: '👤', word: 'esohamasmi', pronKo: '에소하마스미', meaning: '"이것이 나다" (eso aham asmi)',
    grammar: '대명사+대명사+동사', baseForm: 'eso + ahaṃ + asmi',
    formNote: '"이것이 + 나 + 이다"',
    buddhism: '아견의 둘째 — 자만(māna)의 표현.',
    verseLine: V6, verseLineKo: V6K, audio: true },
  { type: 'teach', icon: '🧠', word: 'eso me attā', pronKo: '에소 메 앗따~', meaning: '"이것이 나의 자아다"',
    grammar: '대명사+속격+주격', baseForm: 'eso + me + attā',
    buddhism: '아견의 셋째 — 견해(diṭṭhi)의 표현.\n3가지 합쳐 모든 잘못된 자아 견해 표적.',
    verseLine: V6, verseLineKo: V6K, audio: true },

  { type: 'teach', icon: '⏰', word: 'atīta·anāgata·paccuppanna', pronKo: '아띠~따·아나~가따·빳쭙빤나', meaning: '과거·미래·현재 (3시제 원형)',
    grammar: '과거분사 3개', baseForm: 'atīta + anāgata + paccuppanna',
    formNote: '시간의 3차원. atītānāgatapaccuppannaṃ = 복합어',
    verseLine: V7, verseLineKo: V7K, audio: true },
  { type: 'teach', icon: '🪨', word: 'oḷārika·sukhuma', pronKo: '올라~리까·수쿠마', meaning: '거친·미세한 (원형)',
    grammar: '형용사 2개', baseForm: 'oḷārika + sukhuma',
    verseLine: V7, verseLineKo: V7K, audio: true },
  { type: 'teach', icon: '⬇️', word: 'hīna·paṇīta', pronKo: '히~나·빠니~따', meaning: '저열한·고귀한 (원형)',
    grammar: '형용사 2개', baseForm: 'hīna + paṇīta',
    formNote: '10과 ratana의 paṇītaṃ과 동일',
    verseLine: V7, verseLineKo: V7K, audio: true },
  { type: 'teach', icon: '📏', word: 'dūre·santike', pronKo: '두~레·산띠께', meaning: '먼·가까운 (처격)',
    grammar: '부사 (처격)', baseForm: 'dūra + santika',
    formNote: '8과 metta의 dūre·avidūre와 같은 단어',
    verseLine: V7, verseLineKo: V7K, audio: true },
  { type: 'teach', icon: '🌍', word: 'sabba', pronKo: '삽바', meaning: '모든 (원형)',
    grammar: '형용사', baseForm: 'sabba',
    formNote: 'sabbaṃ rūpaṃ = 모든 물질',
    verseLine: V7, verseLineKo: V7K, audio: true },
  { type: 'teach', icon: '🔍', word: 'sammappaññā', pronKo: '삼맙빤냐~', meaning: '바른 지혜 (원형)',
    grammar: '복합어, 원형', baseForm: 'sammā + paññā',
    formNote: 'sammā(바른) + paññā(지혜)\n11과 MN10 V_MAG1 sammādiṭṭhi와 같은 sammā',
    verseLine: V7, verseLineKo: V7K, audio: true },
  { type: 'teach', icon: '👁️', word: 'daṭṭhabbaṃ', pronKo: '닷탑방', meaning: '보아야 할 (미래분사)',
    grammar: '미래분사, 주격 중성', baseForm: 'daṭṭhabba (√das 보다)',
    verseLine: V7, verseLineKo: V7K, audio: true },

  { type: 'teach', icon: '🆓', word: 'vimuccati', pronKo: '위뭇짜띠', meaning: '해탈한다',
    grammar: '동사 3인칭 단수', baseForm: 'vimuccati (vi + √muc)',
    formNote: '11과 MN10 V_CIT2의 vimuttaṃ과 같은 어근',
    buddhism: '해탈. 5비구 해탈의 핵심 동사.',
    verseLine: V8, verseLineKo: V8K, audio: true },
  { type: 'teach', icon: '💧', word: 'āsava', pronKo: '아~사와', meaning: '번뇌 (누, 漏)',
    grammar: '남성명사, 원형', baseForm: 'āsava',
    formNote: 'āsavehi = 도구격 복수',
    buddhism: '누(漏). 욕루·유루·견루·무명루. āsava 멸진 = 아라한.',
    verseLine: V10, verseLineKo: V10K, audio: true },
  { type: 'teach', icon: '🚫', word: 'anupādāya', pronKo: '아누빠~다~야', meaning: '취착 없이 (절대분사)',
    grammar: '절대분사', baseForm: 'an + upādāya',
    formNote: '11과 MN10 REF_KAYA의 upādiyati(집착하다)의 부정',
    buddhism: '무취착(無取著). 아라한의 표지.',
    verseLine: V10, verseLineKo: V10K, audio: true },
  { type: 'teach', icon: '🎉', word: 'vimucciṃsu', pronKo: '위뭇찡수', meaning: '해탈하였다 (3인칭 복수 아오리스트)',
    grammar: '동사 3인칭 복수 아오리스트', baseForm: 'vimuccati',
    verseLine: V10, verseLineKo: V10K, audio: true },
  { type: 'teach', icon: '📜', word: 'veyyākaraṇa', pronKo: '웨이야~까라나', meaning: '설명, 해설',
    grammar: '중성명사', baseForm: 'veyyākaraṇa',
    verseLine: V10, verseLineKo: V10K, audio: true },
  { type: 'teach', icon: '🗣️', word: 'bhaññamāne', pronKo: '반냐마~네', meaning: '설해질 때 (현재분사 수동, 처격)',
    grammar: '수동 현재분사, 처격', baseForm: 'bhāsati 수동',
    verseLine: V10, verseLineKo: V10K, audio: true },
